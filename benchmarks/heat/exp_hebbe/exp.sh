...
echo "RWSS"
echo "****************************************************************************************************"
TAO_NOPLO=T1 AWIDTH=2 EXDECOMP=10 EYDECOMP=2 IXDECOMP=2 IYDECOMP=1 numactl -i all ../heat-tao-rwss ${INPUTFILE}
echo "****************************************************************************************************"
echo "NUMA-Aware"
echo "****************************************************************************************************"
TAO_NOPLO=T1 AWIDTH=2 EXDECOMP=10 EYDECOMP=2 IXDECOMP=2 IYDECOMP=1 numactl -i all ../heat-tao-numa ${INPUTFILE}
echo "****************************************************************************************************"
echo "NUMA-Auto-No-Mold"
echo "****************************************************************************************************"
export XITAO_LAYOUT_PATH=${XITAO_PTT_PATH}/ptt_layout_1
TAO_NOPLO=T1 AWIDTH=2 EXDECOMP=10 EYDECOMP=2 IXDECOMP=2 IYDECOMP=1 numactl -i all ../heat-tao-numa-auto ${INPUTFILE}
echo "****************************************************************************************************"
